...
export const SupportedCurrency: React.FC = () => {
  return (
    <div className="self-end w-fit ml-auto translate-x-6 md:translate-x-0 lg:translate-x-12 flex gap-x-2 justify-between items-center bg-[#22251B] rounded-full p-[5.13px] pl-4 md:p-[6.89px] md:pl-[16.53px] 2xl:p-[9px] 2xl:pl-[21px]">
      ...
      <div className="bg-shades-grey-10 border border-shades-grey-15 rounded-full flex items-center gap-x-1 md:gap-x-[5.51px] 2xl:gap-x-[6.94px] p-[5.13px] md:p-[6.89px] 2xl:p-[8.67px]">
        {currencies.map((currency) => (
          <div key={currency} className="p-1.5 bg-shades-grey-15 rounded-full">
            <Image
