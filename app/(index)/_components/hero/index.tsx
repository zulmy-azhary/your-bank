      ...
      <div className="flex flex-col gap-y-3 md:gap-y-4 2xl:gap-y-5 items-center lg:items-start">
        <Reveal from="left">
          <p className="flex items-center gap-x-1 2xl:gap-x-1.5 w-fit text-xs md:text-sm 2xl:text-lg font-extralight p-2 pr-4 2xl:py-2.5 2xl:pl-3 2xl:pr-5 bg-shades-grey-15 rounded-full leading-6">
            <HiCheckBadge className="size-5 text-shades-green-60" /> No LLC Required, No Credit
            Check.
          </p>
        </Reveal>
  ...
  return (
    <div className="flex flex-col items-center relative">
      <div className="space-y-3">
        <Reveal from="bottom" delay={0} wrapperClassName="overflow-visible">
          <Card
            className={cn(
          ...
          >
            <Reveal
              delay={0.5}
              wrapperClassName="absolute -z-10 top-0 right-0 -translate-y-6 translate-x-[3.25rem] md:-translate-y-24 md:translate-x-32 lg:-translate-y-2 lg:translate-x-24 xl:translate-x-36 2xl:translate-y-2 2xl:translate-x-[10.75rem] "
            >
              <Image
                ...
                sizes="auto"
                priority
                className="w-60 md:w-80 2xl:w-96"
              />
            </Reveal>
            <MonthlyIncome income={"+ $5000,00"} />
            <Transaction />
            <MoneyExchange />
            <Reveal wrapperClassName="w-full" delay={1.5}>
              <Button
                variant="accent"
